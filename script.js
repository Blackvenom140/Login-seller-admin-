...
import { getDatabase, ref, set, remove, push, get, onValue, update } from "https://www.gstatic.com/firebasejs/10.7.1/firebase-database.js";
...
// Function to delete admin from Firebase
function deleteAdmin(adminKey, adminId) {
        ...
        if (snapshot.exists()) {
            snapshot.forEach((childSnapshot) => {
                ...
                div.innerHTML = `
                    ...
                    <strong>Expires In:</strong> ${remainingTime > 0 ? formatTime(remainingTime) : "Expired"} <br>
                    <button onclick="deleteAdmin('${adminKey}', '${data.adminId}')">🗑️ Delete</button>
                `;
